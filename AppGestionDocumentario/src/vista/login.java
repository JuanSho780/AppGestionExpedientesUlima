...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Registrar nuevo administrador");

        RegistrarAdmin.setBackground(new java.awt.Color(0, 0, 0));
        RegistrarAdmin.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        RegistrarAdmin.setForeground(new java.awt.Color(242, 111, 33));
        RegistrarAdmin.setText("Registrar");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(518, 518, 518)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(RegistrarAdmin, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(RegistrarAdmin, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void IniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IniciarSesionActionPerformed
        ...
        this.adm = SistemaMain.autenticarUsuario(usuario, contraseña);
        
        if (this.adm != null) {
            IniciarSesion.setBackground(Color.BLACK);
            // Abre la ventana principal
            principal frame = new principal(this.adm); //ESTE ES EL CONSTRUCTOR DE PRINCIPAL (HOME)
    ...
    private void RegistrarAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegistrarAdminActionPerformed
        // TODO add your handling code here:
            RegistrarAdministrador frame3 = new RegistrarAdministrador();

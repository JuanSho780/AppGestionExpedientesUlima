...
public class VisualizarExpediente extends javax.swing.JFrame {
    private AdministradorDelSistema adm;
    private DefaultTableModel model;
            
    public VisualizarExpediente(AdministradorDelSistema adm) {
        this.adm = adm;
        initComponents();
        ...
        model.addColumn("Tiempo Término");
        
        String[][] datos = ExpedientesFinalizados.obtenerArrayInfoTramiteTerminados();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("EXPEDIENTE -> Visualizar");
        ...
        jLabel2.setText("EXPEDIENTES FINALIZADOS:");
    ...
    private void mainActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mainActionPerformed
        // ESTE BOTON TE LLEVA A LA PAGINA PRINCIPAL (HOME)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualizarExpediente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new VisualizarExpediente().setVisible(true);
            }
        });
    }

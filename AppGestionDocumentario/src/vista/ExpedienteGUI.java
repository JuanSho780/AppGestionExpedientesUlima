...
public class ExpedienteGUI extends javax.swing.JFrame {
    private AdministradorDelSistema adm;
    
    public ExpedienteGUI(AdministradorDelSistema adm) {
        this.adm = adm;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        visualizarExp.setText("Visualizar expedientes finalizados");
        ...
        BotonBuscarExpediente.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        BotonBuscarExpediente.setText("Buscar Expediente según ID");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(42, 42, 42)
                        .addComponent(BotonBuscarExpediente)
                        .addGap(47, 47, 47))))
        );
    ...
    private void mainActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mainActionPerformed
        // ESTE BOTON TE LLEVA AL HOME (PRINCIPAL) DE LA PAGINA
    ...
    private void expedienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_expedienteActionPerformed
        // ESTE BOTON ES EL DE ESTA PÁGINA
...
//ESTOS DOS BOTONES SON LOS QUE DE FUNCIONALIDADES
    ...
    private void visualizarExpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_visualizarExpActionPerformed
        // ESTE BOTON TE AYUDA A VISUALIZAR (EXPEDIENTES TERMINADOS O EL EXPEDIENTE SEGÚN ID)
        VisualizarExpediente frame = new VisualizarExpediente(this.adm);
        frame.setVisible(true);
        this.dispose();
    ...
    private void BotonBuscarExpedienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonBuscarExpedienteActionPerformed
        // ESTE BOTON TE AYUDA A BUSCAR UN EXPEDIENTE (SIN IMPORTAR SU DEPENDENCIA)
        BuscarExpediente frame = new BuscarExpediente(this.adm);
        frame.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExpedienteGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
